...
.btn-danger:hover {
  background-color: #b91c1c;
    ...
    },
    {
      ...
      category: 'States',
      component: (
        <button className="px-6 py-3 bg-slate-300 text-slate-500 rounded-lg cursor-not-allowed" disabled>
          Disabled
        </button>
      ),
    ...
    <div className='space-y-12 max-w-6xl mx-auto mt-10 md:mt-[60px]'>
      {categories.map(category => (
        <section key={category}>
          <h2 className='mb-6 pb-4 border-b border-slate-200 text-2xl font-semibold'>{category} Buttons</h2>
